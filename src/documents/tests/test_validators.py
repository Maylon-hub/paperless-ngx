...
class TestValidators:
    ...
    def test_uri_validator_general_exception(self, mock_urlparse):
        ...
        with pytest.raises(ValidationError, match="Unable to parse URI http://example.com"):
            uri_validator("http://example.com")
